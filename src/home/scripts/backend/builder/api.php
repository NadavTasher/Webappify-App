...
const BUILDER_DOCKERFILE_FILE = __DIR__ . DIRECTORY_SEPARATOR;
const BUILDER_MASTER_FILE = __DIR__ . DIRECTORY_SEPARATOR;
const BUILDER_FLAVOUR_DIRECTORY = __DIR__ . DIRECTORY_SEPARATOR;
const BUILDER_APPS_DIRECTORY = __DIR__ . DIRECTORY_SEPARATOR;
